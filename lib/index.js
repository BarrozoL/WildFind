...
export const getAllWatchlistItems = async () => {
  try {
    const response = await axios.get(`${ANIMALS_DB}/api/watchlist`);
    return response.data;
  } catch (error) {
    console.log(error);
  }
...
export const getAllAnimals = async () => {
  try {
    const response = await axios.get(`${ANIMALS_DB}/api/specimens`);
    return response.data;
  } catch (error) {
    console.log(error);
  }
...
export const getAnimal = async (id) => {
  try {
    const response = await axios.get(`${ANIMALS_DB}/api/specimens/${id}`);
    return response.data;
  } catch (error) {
    console.log(error);
  }
...
export const getAnimalsWithSightings = async (specimenId) => {
  try {
    const response = await axios.get(
      `${ANIMALS_DB}/specimens/${specimenId}/sightings`
    );
    return response.data;
  } catch (error) {
    console.log(error);
...
/* export const getAnimalSightings = async () => {
  try {
